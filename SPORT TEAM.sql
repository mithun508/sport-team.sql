...
SELECT TEAM_NAME, (SELECT AVG(AGE) FROM PLAYERS 
WHERE TEAM_ID = T.TEAM_ID) AS AVERAGE_AGE FROM TEAMS T;

SELECT TEAM_NAME, SUM(RUNS) AS TOTAL_RUNS
FROM SCOREBOARD
GROUP BY TEAM_NAME;
